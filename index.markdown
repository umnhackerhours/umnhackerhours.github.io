  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="alert alert-success" role="alert">
        We are not meeting on November 9th. Instead, we suggest you attend the <a href='http://code-people.umn.edu/upcoming/2016/11/10/tech-people-supermeeting.html'>TechPeople Super Meeting on November 10th</a>!
      </div>
      <div class="alert alert-success" role="alert">
        <a class="anchor" id="next_meeting"></a>
        <strong>Next Meeting</strong>:<br />
        Wednesday, November 16<sup>th</sup><br />
